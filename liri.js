...
//new - key word of javascript. Twitter - Part of npm package
//Line 7 twitter is a function
...
function fetchTwitter(){
	...
	var parmas = {screen_name: 'The_10th'};
    //get means when you want something from the server//post is sending to the server
    //this is a callback function inside the .get. Is it saying I am going to do something when the information sent to me 
    client.get('statuses/user_timeline', function(error, tweets, response) {
        ...
        //This is the starting point. TL should be equal to 0
        tweetsLength = 0;
        //When you run this you will see created_at & text 
        console.log(tweets);
        //you can reference the code below to simplify this
		...
		for (var i=0; i<tweetsLength; i++){
			...
			console.log("--------------------------------------------------------------");
            //this would need to go to a log.txt file
...
function fetchSpotify(){
	...
	spotify.search({ type: 'track', query: songName}, function(err, data) {
	    ...
	    var matchedTracks = [];
        //this is coming from spotify server 
